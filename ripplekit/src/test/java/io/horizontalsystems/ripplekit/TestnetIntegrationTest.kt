...
import io.horizontalsystems.ripplekit.sync.TransactionConverter
import io.horizontalsystems.ripplekit.transaction.Signer
import io.horizontalsystems.ripplekit.transaction.TransactionBuilder
...
class TestnetIntegrationTest {
    ...
    fun fundSendAndValidate() = runBlocking {
        ...
        val common = TransactionBuilder.Common(
            ...
            memo = "ripple-chain-android integration",
        )
        ...
        assertEquals("ripple-chain-android integration", record.memo)
