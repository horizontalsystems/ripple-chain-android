package io.horizontalsystems.xrpkit.database
...
import io.horizontalsystems.xrpkit.models.TransactionSyncState
...
internal object XrpDatabaseManager {
    private fun name(network: Network, walletId: String) = "Xrp-${network.name}-$walletId"
